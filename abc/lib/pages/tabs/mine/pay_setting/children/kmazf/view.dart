...
import 'package:abc/pages/tabs/mine/card_manage/children/yhkgl_detail/children/kjzfjy/state.dart';
import 'package:abc/pages/tabs/mine/pay_setting/children/kmazf/state.dart';
...
class KmazfPage extends BaseStateless {
  KmazfPage({Key? key}) : super(key: key, title: "k码支付");

  final KmazfLogic logic = Get.put(KmazfLogic());
  final KmazfState state = Get.find<KmazfLogic>().state;
