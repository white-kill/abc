...
class OpenmmzfPage extends BaseStateless {
  OpenmmzfPage({Key? key}) : super(key: key, title: "密码支付");

  final OpenmmzfLogic logic = Get.put(OpenmmzfLogic());
  final OpenmmzfState state = Get.find<OpenmmzfLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'mmzf'.png3x, width: screenWidth, fit: BoxFit.fitWidth,),
            Positioned(
              right: position.getX(50),
              top: position.getY(50),
              child: Obx(() {
                return Container(
                  color: Colors.white,
