...
class SsdlPage extends BaseStateless {
  SsdlPage({Key? key}) : super(key: key, title: "手势登录");

  final SsdlLogic logic = Get.put(SsdlLogic());
  final SsdlState state = Get.find<SsdlLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'finger'.png3x, width: screenWidth, fit: BoxFit.fitWidth,),
            Positioned(
