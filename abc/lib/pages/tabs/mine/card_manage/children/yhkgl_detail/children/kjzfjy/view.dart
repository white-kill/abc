...
class KjzfjyPage extends BaseStateless {
  KjzfjyPage({Key? key}) : super(key: key, title: "快捷支付");

  final KjzfjyLogic logic = Get.put(KjzfjyLogic());
  final KjzfjyState state = Get.find<KjzfjyLogic>().state;
