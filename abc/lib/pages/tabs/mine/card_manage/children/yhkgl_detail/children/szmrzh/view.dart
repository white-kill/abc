...
class SzmrzhPage extends BaseStateless {
  SzmrzhPage({Key? key}) : super(key: key, title: "设置默认账户");

  final SzmrzhLogic logic = Get.put(SzmrzhLogic());
  final SzmrzhState state = Get.find<SzmrzhLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'she_zhi_mo_ren'.png),
