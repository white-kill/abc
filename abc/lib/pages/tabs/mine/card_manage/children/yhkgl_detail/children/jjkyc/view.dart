...
class JjkycPage extends BaseStateless {
  JjkycPage({Key? key}) : super(key: key, title: "借记卡隐藏");

  final JjkycLogic logic = Get.put(JjkycLogic());
  final JjkycState state = Get.find<JjkycLogic>().state;
