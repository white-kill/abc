...
import 'package:abc/pages/tabs/mine/card_manage/children/yhkgl_detail/children/wkzfxe/state.dart';
...
class WkzfxePage extends BaseStateless {
  WkzfxePage({Key? key}) : super(key: key, title: "无卡支付限额");

  final WkzfxeLogic logic = Get.put(WkzfxeLogic());
  final WkzfxeState state = Get.find<WkzfxeLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'wu_ka_zhi_fu'.png3x),
