...
import 'package:abc/pages/tabs/mine/card_manage/children/yhkgl_detail/children/qkxe/state.dart';
...
class QkxePage extends BaseStateless {
  QkxePage({Key? key}) : super(key: key, title: "取款限额");

  final QkxeLogic logic = Get.put(QkxeLogic());
  final QkxeState state = Get.find<QkxeLogic>().state;
