...
class DxtzPage extends BaseStateless {
  DxtzPage({Key? key}) : super(key: key, title: "短信通知");

  final DxtzLogic logic = Get.put(DxtzLogic());
  final DxtzState state = Get.find<DxtzLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'dxtz'.png),

            Positioned(
              left: position.getX(100),
              top: position.getY(240),
              child: BaseText(
