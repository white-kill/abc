...
class DkzzxePage extends BaseStateless {
  DkzzxePage({Key? key}) : super(key: key, title: "单卡转账限额");

  final DkzzxeLogic logic = Get.put(DkzzxeLogic());
  final DkzzxeState state = Get.find<DkzzxeLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Stack(
          children: [
            Image(image: 'dan_ka_zhuan'.png3x),
