...
class ZqPage extends BaseStateless {
  @override
  ...
  Widget initBody(BuildContext context) {
    final logic = Get.put(ZqLogic());

    return SingleChildScrollView(
      child: Column(
        children: [
          CcWidget(),
          Image(image: 'cf_zq_1'.png, width: screenWidth, fit: BoxFit.fitWidth),
          Image(image: 'cf_zq_2'.png, width: screenWidth, fit: BoxFit.fitWidth),
        ],
      ),
    );
  }
