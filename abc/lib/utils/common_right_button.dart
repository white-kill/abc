...
import '../pages/tabs/other/customer/customer_view.dart';
import '../pages/tabs/home/subpages/message/message_view.dart';
...
class CommonRightButton {
  ...
  static Widget _buildSearchButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'icon_search').png3x,
  ...
  static Widget _buildCustomerButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'kefu').png3x,
      width: config.iconWidth ?? 22.w,
      height: config.iconHeight ?? 22.w,
      color: config.iconColor,
    ).withOnTap(
  ...
  static Widget _buildMessageButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'xiaoxi').png3x,
      width: config.iconWidth ?? 22.w,
      height: config.iconHeight ?? 22.w,
      color: config.iconColor,
    ).withOnTap(
  ...
  static Widget _buildSettingButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'icon_setting').png3x,
  ...
  static Widget _buildVersionButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'banben').png3x,
      width: config.iconWidth ?? 22.w,
      height: config.iconHeight ?? 22.w,
      color: config.iconColor,
    ).withOnTap(
      onTap: config.onTap ?? () {
        Get.toNamed(Routes.fixedNavPage, arguments: config.routeArguments ?? {
          'title': '版本切换',
          'image': 'bg_banben',
        });
      },
  ...
  static Widget _buildExportButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'mingxi_dao').png3x,
      width: config.iconWidth ?? 20.w,
      height: config.iconHeight ?? 20.w,
      color: config.iconColor,
    ).withOnTap(
  ...
  static Widget _buildShareButton(RightButtonConfig config) {
    return Image(
      image: (config.iconPath ?? 'share').png,
      width: config.iconWidth ?? 20.w,
      height: config.iconHeight ?? 20.w,
      color: config.iconColor,
    ).withOnTap(
